package xyz.solidspoon.coupon.template.service;

import xyz.solidspoon.coupon.template.api.beans.CouponTemplateInfo;
import xyz.solidspoon.coupon.template.api.beans.PagedCouponTemplateInfo;
import xyz.solidspoon.coupon.template.api.beans.TemplateSearchParams;
import xyz.solidspoon.coupon.template.api.beans.rules.Discount;
import xyz.solidspoon.coupon.template.api.enums.CouponType;
import xyz.solidspoon.coupon.template.converter.CouponTemplateConverter;
import xyz.solidspoon.coupon.template.dao.CouponTemplateDao;
import xyz.solidspoon.coupon.template.dao.entity.CouponTemplate;
import xyz.solidspoon.coupon.template.service.intf.CouponTemplateService;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    public List<CouponTemplateInfo> searchTemplate(CouponTemplateInfo request) {
        xyz.solidspoon.coupon.template.dao.entity.CouponTemplate example = xyz.solidspoon.coupon.template.dao.entity.CouponTemplate.builder()
                .shopId(request.getShopId())
                .category(CouponType.convert(request.getType()))
                .available(request.getAvailable())
                .name(request.getName())
...
//        templateDao.findAll(Example.of(example), page);
        List<xyz.solidspoon.coupon.template.dao.entity.CouponTemplate> result = templateDao.findAll(Example.of(example));
    ...
    public Map<Long, CouponTemplateInfo> getTemplateInfoMap(Collection<Long> ids) {
        ...
        List<xyz.solidspoon.coupon.template.dao.entity.CouponTemplate> templates = templateDao.findAllById(ids);
